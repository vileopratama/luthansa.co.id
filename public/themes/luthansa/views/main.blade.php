...
<html>
	...
	<meta name="keywords" content="Sewa Bus Wisata, Sewa Bus Pariwisata, Sewa Bus, Sewa Bus Wisata di Jakarta" />
	<meta name="description" content="Anda Ingin Sewa Bus Wisata untuk kebutuhan Pariwisata Anda. Silahkan Order via Website https://www.luthansa.co.id"/>
	<meta name="generator" content="palingpertama.com" />
	<title>Sewa Bus Wisata | Bus Pariwisata Luthansa</title>
						...
						<div class="nav"> 
							...
							<nav class="menu">
								<ul>
									...
									<li class="type-1 {!! (Request::segment(2)=='medium-bus-31-31-seats' || Request::segment(2)=='micro-bus-21-seats' || Request::segment(2)=='micro-bus-17-19-seats') ?'active':'' !!}"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{!! Lang::get('menu.fleets') !!} <span class="fa fa-angle-down"></span> </a>
									...
									<li class="type-1 {!! Request::segment(2)=='portal'       ?'active':'' !!}"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{!! Lang::get('menu.portal') !!}<span class="fa fa-angle-down"></span></a>
										<ul class="dropdown-menu">
											@if(!Auth::check())
