		...
		<div class="detail-header">
			<div class="row">
				<div class="col-xs-12 col-sm-8">
					<h2 class="detail-title color-dark-2">MICRO BUS 21 Seats</h2>
						...
						<div class="swiper-container thumbnails-preview" data-autoplay="0" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
			                <div class="swiper-wrapper">
		                    	<div class="swiper-slide active" data-val="0">
		                    		 <img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_1.jpg') !!}" alt="">
		                    	</div>
		                    	<div class="swiper-slide" data-val="1">
		                    		 <img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_2.jpg') !!}" alt="">
		                    	</div>
		                    	<div class="swiper-slide" data-val="2">
		                    		 <img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_3.jpg') !!}" alt="">
		                    	</div>
		                    	<div class="swiper-slide" data-val="3">
		                    		 <img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_4.jpg') !!}" alt="">	 
		                    	</div>
		                    	<div class="swiper-slide" data-val="4">
		                    		 <img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_5.jpg') !!}" alt="">         		 
		                    	</div>
								<div class="swiper-slide" data-val="5">
		                    		 <img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_9.jpg') !!}" alt="">         		 
		                    	</div>	
		                    </div>
			            ...
			            data-add-slides="5">
			                <div class="swiper-wrapper">
								<div class="swiper-slide current active" data-val="0">
									<img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_1s.jpg') !!}" alt="">
								</div>
								<div class="swiper-slide" data-val="1">
									<img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_2s.jpg') !!}" alt="">
								</div>
								<div class="swiper-slide" data-val="2">
									<img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_3s.jpg') !!}" alt="">
								</div>
								<div class="swiper-slide" data-val="3">
									<img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_4s.jpg') !!}" alt="">
								</div>
								<div class="swiper-slide" data-val="4">
									<img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_5s.jpg') !!}" alt="">
								</div>
								<div class="swiper-slide" data-val="5">
									<img class="img-responsive img-full" src="{!! asset('themes/luthansa/assets/img/detail/mi21_slide_9s.jpg') !!}" alt="">
								</div>	
							</div>
