		...
		<div class="detail-header">
			<div class="row">
				<div class="col-xs-12 col-sm-8">
					<h2 class="detail-title color-dark-2">MEDIUM BUS 31 SEATS</h2>
			    ...
			    <div class="col-xs-12 col-sm-4">
			    	<div class="detail-price color-dark-2">Harga Mulai  <span class="color-dr-blue"> IDR 1.400.000</span> /Hari</div>
			    </div>
	       	</div>
       	</div>
       		...
       		<div class="col-xs-12 col-md-8">
       			<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 800px; height: 530px; overflow: hidden; visibility: hidden; background-color: #24262e;">
					...
					<div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 800px; height: 450px; overflow: hidden;">
						...
						<div data-p="144.50">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/1.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/1.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/2.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/2.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/3.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/3.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/4.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/4.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/5.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/5.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/6.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/6.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/7.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/7.jpg', 225, 225) }}" />
						</div>
						
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/8.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/8.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/9.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/9.jpg', 225, 225) }}" />
						</div>
						<div data-p="144.50" style="display: none;">
							<img data-u="image" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/10.jpg', 800, 465) }}" />
							<img data-u="thumb" src="{{ App\Classes\Img::resize('/shared/img/medium-bus-31/10.jpg', 225, 225) }}" />
						</div>
       			...
       			<div class="right-sidebar">
       				<div class="detail-block bg-dr-blue">
       					...
       					<div class="details-desc">
							<p class="color-grey-9">Armada:  <span class="color-white">MEDIUM BUS 31 SEATS</span></p>
